...
public class TwitterSpout extends BaseRichSpout {
    ...
    String _username;
    String _pwd;
    String consumer_key="PnNnNOkzgTG3typPW72C4c0il";
    String consumer_secret="suXnPuuWHchDLmgf5a7RjNXitGxH9hHjYkR2ZfgCgdFsDfjuQv";
    String access_token="2310210140-XeAC5XdAUyxnMrd2wkPQ1YtCVMTYOvdGv03pvSv";
    String token_secret="Xo9UdAXsIX2aG2a7Xfze2mf9QHMuQbQoWdvwnuHFEMyRl";
